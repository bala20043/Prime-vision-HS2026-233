...
export default function Header() {
  ...
  // Single Click: Home Page
  const handleLogoClick = () => {
    navigate('/');
  };

  // Double Click: Admin Shortcut
    ...
    <>
      <header className="sticky top-0 z-50 bg-ink text-parchment border-b border-parchment/10">
        <div className="page-container flex items-center justify-between h-24 py-3">
          {/* Logo — Single Click = Home, Double Click = Admin Portal */}
          <div
            onClick={handleLogoClick}
            onDoubleClick={handleLogoDoubleClick}
            className="flex items-center gap-3.5 text-parchment cursor-pointer user-select-none"
            title="Double-click to open Admin Verification"
          >
      ...
      {/* Dedicated Admin Security Login Modal */}
      <AdminLoginModal
